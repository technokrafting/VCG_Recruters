...
(function() {
		...
		function renderOptions(xml)
		{
			...
			var paramsHead = xml.find('params').attr('paramHead');

			th = th + '<th>'+paramsHead+'</th>';
		...
		function loadTemplateCss()
		{
			...
			link.rel  = 'stylesheet';
			link.type = 'text/css';
			link.href = "pages/templates/DropDownVertical/DropDownVertical.css";
			link.media = 'all';
		...
		function sendData(eventObj)
		{
			...
			if(pageId == $pageId)
			{
				...
				//console.log(totalDropDowns+" totalScore "+totalScore);
