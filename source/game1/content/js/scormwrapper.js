/*-------------------------------------------------------------------------------------------------*/
/* 
	Application.as v1.0.0
	
	Copyright (c) 2006 Tata Interactive System

*/
/*-------------------------------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------------------------------
	LMSVersion = "SCORM_2004"
-----------------------------------------------------------------------------------------------------*/
/*******************************************************************************
**
...
var _ServerBusy = 102;
var _RetriveBeforeInitialization = 122;
...
function LMSGetValue(name)
{
   ...
   else
   {
	  ...
	  if (errCode != _NoError && errCode != _NoErrorSet)
	  {
...
function LMSIsInitialized()
{
   ...
   // a simple GetValue and trap for the LMS Not Initialized Error
   ...
   else
   {
      ...
      console.log('Got IsInitialized Error Code',errCode);

      if (errCode == _RetriveBeforeInitialization)
      {
         return false;
      }
      else
...
function getAPI()
{
	...
	//alert("parent.window " +parent.window + " parent.window.opener " + parent.window.opener );
